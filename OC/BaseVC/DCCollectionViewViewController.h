//
//  DCCollectionViewViewController.h
//  FYJ
//
...
@interface DCCollectionViewViewController : BaseViewController<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
